...
const Navbar = () => {
    return (
        <nav className="w-full py-6 px-10 flex justify-center items-center bg-white sticky top-0 z-50">
            <div className="flex space-x-12 text-sm font-medium uppercase tracking-widest">
